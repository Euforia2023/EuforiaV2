...
<body>
     ...
     <div class="wr">
        ...
        <div class="christmas_wrapper">
            <div class="container">
                <div class="timing">
                    <h1 class="timing__title">Do Nowego Roku Zostało:</h1>
                    <br>
                    <div id="zostalo"></div>
                    <br>
                    <div class="LastTime">
    ...
    <div class="player_box">
        <marquee class="user_play" direction="left" width="120" height="30" behavior="scroll" style="border:none">Gra
            dla was:
    ...
    <header class="header section">
        ...
        <!-- <a href="https://polfan.pl/app/" target="_blank" rel="noopener"
            class="header__btn btn-special-animation">Ramówka</a> -->
        <a class="arrow-down-link" href="#ram"><i class="fa-solid fa-chevron-down header__arrow-down"></i></a>
        <div class="white-block white-block-left"></div>
    </header>
            ...
            <div class="wrapper">
                ...
                <div class="presenters__box">
                    <div class="presenters__box-daysHolder">
                        ...
                        <!-- <button class="presenters__btn-days btn-special-animation">
                            wybierz
                        </button> -->
                        <div class="dropholder">
                            <p>Wybierz</p>
                ...
                <!-- <div class="presenters__box-days">
                    <i class="fa-solid fa-x"></i>
                    <div class="presenters__box-day">
                        <li class="presenters__box-link">Poniedziałek</li>
                        <li class="presenters__box-link">wtorek</li>
                        <li class="presenters__box-link">Środa</li>
                        <li class="presenters__box-link">czwartek</li>
                        <li class="presenters__box-link">piątek</li>
                        <li class="presenters__box-link">sobota</li>
                        <li class="presenters__box-link">niedziela</li>
                    </div>
                </div> -->
                ...
                <div class="presenters__box">
                    ...
                    <div class="presenters__box-img presenters__box-img--right">
                        <h3 class="presenters__title">Wtorek</h3>
                        <img src="./img/gradient.png" alt="Przyładowy obrazek" class="presenters__img">
                    </div>

                    <div class="presenters__box-text presenters__box-text--righ">
                        <h3 class="presenters__title">Wtorek</h3>
                        <p id="ShowText2" class="presenters__text"></p>
                    </div>
                ...
                <div class="presenters__box">
                    ...
                    <div class="presenters__box-img">
                        <h3 class="presenters__title">Środa</h3>
                        <img src="./img/gradient.png" alt="Przyładowy obrazek" class="presenters__img">
                    </div>

                    <div class="presenters__box-text">
                        <h3 class="presenters__title">Środa</h3>
                        <p id="ShowText3" class="presenters__text"></p>
                    </div>
                ...
                <div class="presenters__box">
                    ...
                    <div class="presenters__box-img presenters__box-img--right">
                        <h3 class="presenters__title">Czwartek</h3>
                        <img src="./img/gradient.png" alt="Przyładowy obrazek" class="presenters__img">
                    </div>

                    <div class="presenters__box-text presenters__box-text--righ">
                        <h3 class="presenters__title">Czwartek</h3>
                        <p id="ShowText4" class="presenters__text"></p>
                    </div>
                ...
                <div class="presenters__box">
                    ...
                    <div class="presenters__box-img">
                        <h3 class="presenters__title">Piątek</h3>
                        <img src="./img/gradient.png" alt="Przyładowy obrazek" class="presenters__img">
                    </div>

                    <div class="presenters__box-text">
                        <h3 class="presenters__title">Piątek</h3>
                        <p class="presenters__text"></p>
                    </div>
                ...
                <div class="presenters__box">
                    ...
                    <div class="presenters__box-img presenters__box-img--right">
                        <h3 class="presenters__title">Sobota</h3>
                        <img src="./img/gradient.png" alt="Przyładowy obrazek" class="presenters__img">
                    </div>
                ...
                <div class="presenters__box">
                    ...
                    <div class="presenters__box-img">
                        <h3 class="presenters__title">Niedziela</h3>
                        <img src="./img/gradient.png" alt="Przyładowy obrazek" class="presenters__img">
                    </div>
