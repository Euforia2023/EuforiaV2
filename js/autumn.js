...
plow.src =
	'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAJAAAABaCAMAAABg6y9YAAADAFBMVE' +
...
leaf_image[0] =
	'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEgAAABACAMAAACOYMEYAAADAFBMVE' +
...
leaf_image[2] =
	'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEgAAABICAMAAABiM0N1AAADAFBMVE' +
...
function autumn_leaves() {
	...
	if (offset > untidy * leaves && !tidying && Math.random() < 0.05) tidy_leaves()
}
